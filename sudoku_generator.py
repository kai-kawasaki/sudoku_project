...
class SudokuGenerator:
    ...
    def __init__(self, row_length, removed_cells):
        ...
        self.box_length = int(math.sqrt(row_length))  # (can be set to 3)
    ...
    '''
	Returns a blank 2D python list
